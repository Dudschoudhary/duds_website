...
const Services = () => {
    return (
        ...
        <h2 className='text-center text-3xl md:text-[40px] m-4 WorkSans-VariableFont_wght'>Services</h2>
            <div className='flex justify-center items-center w-full my-4 p-4'>
                
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  mx-auto min-h-[calc(100vh-170px)] WorkSans-Italic-VariableFont_wght text-gray-900'>
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
                        <h2 className='my-3 text-xl WorkSans-VariableFont_wght '>1.</h2>
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900  text-transparent bg-clip-text bg-gradient-to-r to-[#cd586e] from-[#b41bf2]">Web design</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-900 ">I specialize in creating visually appealing and user-friendly interfaces. I take design mockups and turn them into code, ensuring that the website’s layout, colors, fonts, and overall aesthetics are consistent and engaging for users.</p>
