        ...
        <div className='w-full box-border'>
          <div className='userProfile w-[100%] sm:w-[70%] lg:w-[50%] lg:p-4 m-auto flex justify-center items-center min-h-[calc(100vh-170px)]'>
            <div className='m-4'>
              ...
              <h1 className='text-center lg:m-6 text-xl md:text-3xl WorkSans-VariableFont_wght font-medium'>I'am Dudarma Choudhary, frountend Developer based in INDIA</h1>
