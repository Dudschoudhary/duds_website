        ...
        <>
            ...
            <div className='flex justify-center items-center w-full my-4 p-4 min-h-[calc(100vh-170px)'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  mx-auto ] WorkSans-Italic-VariableFont_wght text-gray-900'>
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400" data-aos="fade-right" data-aos-duration="1000">
                        <div>
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center'>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://e-commerce-chi-nine-80.vercel.app/'>Live Preview</a></button>
                    ...
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400"  data-aos="fade-down" data-aos-duration="1000">
                        <div>
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center '>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://food-del-eosin.vercel.app/'>Live Preview</a></button>
                    ...
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400"  data-aos="fade-left" data-aos-duration="1000">
                        <div>
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center '>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://responsive-form-template.vercel.app/'>Live Preview</a></button>
                    ...
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400"  data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center '>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://todo-ten-puce-19.vercel.app/'>Live Preview</a></button>
                    ...
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400" data-aos="fade-up" data-aos-duration="1000">
                        <div>
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center '>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://weather-api-hazel-seven.vercel.app/'>Live Preview</a></button>
                    ...
                    <div className="max-w-sm p-6 bg-white border border-gray-200 hover:border hover:border-[#b41bf2] rounded-lg shadow transform transition duration-500 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-r from-yellow-200 to-pink-400" data-aos="fade-left" data-aos-duration="1000">
                        ...
                        <div className='flex justify-start gap-5 my-7 items-center '>
                            <button className='border rounded-full bg-black text-white py-1 px-3 text-sm md:text-base sm:py-3 sm:px-5 bg-gradient-to-r from-purple-500 to-pink-500'> <a href='https://template-1-fa-qs.vercel.app/'>Live Preview</a></button>
