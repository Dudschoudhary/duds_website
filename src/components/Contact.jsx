...
import { validaionForm } from './shemas/Shemas';
const Contact = () => {
    ...
    const { values, errors, touched, handleChange, handleBlur, handleSubmit, resetForm } = useFormik({   // use formik
        ...
        validationSchema: validaionForm ,
        onSubmit: (values) => {
            console.log(values);
            resetForm();
        }
                        ...
                        <div>
                            <form onSubmit={handleSubmit} className='space-y-4'>
                                <div>
                                    ...
                                    <input name='name' value={values.name} onChange={handleChange} type="text" placeholder='Enter your name' className='outline-none border border-gray-300 text-gray-900 rounded-lg py-2 px-3 w-full placeholder:text-sm text-base focus:border-[#b41bf2] WorkSans-VariableFont_wght bg-gray-50 ' data-aos="fade-down" data-aos-duration="1000" />
                                ...
                                <div>
                                    ...
                                    <input name='email' value={values.email} onChange={handleChange} type="email" placeholder='Enter your email' className='outline-none border  border-gray-300  text-gray-900 rounded-lg py-2 px-3 w-full placeholder:text-sm text-base focus:border-[#b41bf2] WorkSans-VariableFont_wght bg-gray-50 ' data-aos="fade-right" data-aos-duration="1000" />
